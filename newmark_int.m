...
% Calculate newmark integration parameters
...
% Set initial values - zeros
u(1) = u0;
udot(1) = udot0;
% Set initial values - acceleration
...
for i = 1:(length(t)-1)
    ...
    % Calculate velocity and accel derivatives
