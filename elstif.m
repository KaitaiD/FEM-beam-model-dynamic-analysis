...
%
% Calculate shpe functions w.r.t local/global coordinates. Then calculate 
% Jacobian + it's determinate.  Lastly calculate the element stiffness.
%
        ...
        for i = 1:ndof
          for b = 1:nelnodes
            for k = 1:ndof
              ...
              for j = 1:ncoord
                for l = 1:ncoord
% Stiffness = previous_calue + constitutive tensor * Shape funstions * integration weights * jacobian_determinate
